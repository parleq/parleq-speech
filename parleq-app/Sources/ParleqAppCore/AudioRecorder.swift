...
public final class AudioRecorder {
    ...
    public var chunkHandler: (@Sendable (Data) -> Void)?
    ...
    public var continueOtherAudio: Bool = true
    ...
    /// device reconnects.
    public var explicitInputDeviceUID: String = ""
    ...
    public func warmupCapture(durationMillis: Int = 250) {
...
public struct InputDeviceInfo: Hashable, Sendable {
...
public func availableInputDevices() -> [InputDeviceInfo] {
    var size: UInt32 = 0
...
public func effectiveMicrophoneName(forExplicitUID uid: String) -> String? {
    if uid.isEmpty {
...
public func logInputDeviceDiagnostics() {
    var size: UInt32 = 0
    var listAddr = AudioObjectPropertyAddress(
        mSelector: kAudioHardwarePropertyDevices,
        mScope: kAudioObjectPropertyScopeGlobal,
