...
enum KeychainStore {
    ...
    /// separate ones.
    static let awsStaticCredentialsAccount = "aws-static-credentials"
    ...
    /// opaque string.
    static let bedrockAPIKeyAccount = "bedrock-api-key"
    ...
    static let azureAPIKeyAccount = "azure-openai-key"
    ...
    static let vertexServiceAccountJSONAccount = "vertex-service-account-json"
    ...
    @discardableResult
    static func setGeminiAPIKey(_ key: String) -> Bool {
    ...
    @discardableResult
    static func removeGeminiAPIKey() -> Bool {
    ...
    struct AWSStaticCredentials: Equatable {
    ...
    @discardableResult
    static func setAWSStaticCredentials(_ creds: AWSStaticCredentials) -> Bool {
    ...
    static func readAWSStaticCredentials() -> AWSStaticCredentials? {
    ...
    @discardableResult
    static func removeAWSStaticCredentials() -> Bool {
    ...
    static var hasAWSStaticCredentials: Bool {
    ...
    @discardableResult
    static func setAzureAPIKey(_ key: String) -> Bool {
        set(account: azureAPIKeyAccount, value: key)
    }

    static func readAzureAPIKey() -> String? {
        read(account: azureAPIKeyAccount)
    }

    @discardableResult
    static func removeAzureAPIKey() -> Bool {
        delete(account: azureAPIKeyAccount)
    }

    /// Settings-UI predicate. Doesn't materialize the secret value.
    static var hasAzureAPIKey: Bool {
        readAzureAPIKey() != nil
    }
